...
namespace EarnHome.Areas.Admin.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Fullname,IsAdmin,Email,Password,UserSkillsId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Fullname,IsAdmin,Email,Password,UserSkillsId")] User user)
        {
            if (ModelState.IsValid)
            {
